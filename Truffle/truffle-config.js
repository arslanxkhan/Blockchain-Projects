...
const { MNEMONIC, INFURA_PROJECT_ID, ALCHEMY_PROJECT_ID } = process.env;
...
module.exports = {
  ...
  networks: {
    ...
    infura_holesky: {
      ...
      gasPrice: 10000000000, // 10 Gwei (You can adjust this value depending on the network)
      confirmations: 2, // # of confirmations to wait between deployments. (default: 0)
      timeoutBlocks: 500, // Increased timeout to 500 blocks
      networkCheckTimeout: 1000000, // Increased network check timeout to 1,000,000ms
